 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_block_module']['type'] = array('Typy', 'Please select the type.');
...
$GLOBALS['TL_LANG']['tl_block_module']['edit']	= array('Edit block-module','Edit block-module ID %s');
